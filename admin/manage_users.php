...
<section class="dashboard">
    <div class="container dashboard_container">
        ...
        <aside>
            ...
            <ul>
                <li><a href="dashboard.html"><i class="fa-solid fa-newspaper"></i>
                    <h5>Manage Post</h5>
                </a></li>
            </ul>
            <ul>
            ...
            <ul>
                <li><a href="manage_users.html" class="active"><i class="fa-solid fa-users" style="color: #ffffff;"></i></i></i>
                    <h5>Manage User</h5>
                </a></li>
            </ul>
            <ul>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>John Witk</td>
                        <td>John234</td>
                        <td><a href="edit_user.html" class="btn sm">Edit</a></td>
                        <td><a href="delete-user.html" class="btn danger">Delete</a></td>
                        <td>Yes</td>
                    </tr>
                    <tr>
                        <td>John Witk</td>
